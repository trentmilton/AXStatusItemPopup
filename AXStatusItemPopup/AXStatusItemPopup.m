...
{
	if (self.statusItemPopupDelegate && [self.statusItemPopupDelegate respondsToSelector:@selector(statusItemDidShow)]) {
		[self.statusItemPopupDelegate statusItemDidShow];
	}
}
